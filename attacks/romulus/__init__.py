...
oracles = ['xmega', 'stm32', 'emulator']
verifiers = ['xmega', 'stm32', 'emulator', 'native']

def init_subcommand(subparser: ArgumentParser):
    subparser.add_argument('-s', '--source', dest='source', choices=sources, default=None, help='source of the traces')
    ...
    subparser.add_argument('-b', '--benchmark', dest='benchmark', action='store_const', const=True, default=False)
